...
API RESTful desenvolvida em **Java com Spring Boot e Spring Data JPA** A API: gerenciamento de clientes, catálogo de produtos com categorias, pedidos e pagamento  .
